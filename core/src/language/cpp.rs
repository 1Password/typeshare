...
impl Language for Cpp {
    ...
    fn format_special_type(
        ...
        Ok(match special_ty {
            SpecialRustType::Vec(rtype) => format!("std::vector<{}>", self.format_type(rtype, generic_types)?),
    ...
    fn write_imports(
        ...
        Ok(())
            ...
            SpecialRustType::Slice(rtype) => format!("std::vector<{}>", self.format_type(rtype, generic_types)?),
            SpecialRustType::Option(rtype) => format!("std::optional<{}>", self.format_type(rtype, generic_types)?),
