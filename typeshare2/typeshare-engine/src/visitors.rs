...
use typeshare_model::{
    ...
    prelude::{CrateName, FilesMode, ParsedData, RustEnumVariant, RustItem, RustType, TypeName},
};
...
pub fn all_reference_type_names(ty: &RustType) -> impl Iterator<Item = &'_ str> + '_ {
